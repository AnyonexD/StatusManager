        ...
        return ft.Dropdown(   # <-- agora ele devolve o componente
            ...
            options=[
                ...
                ft.dropdown.Option(
                    ...
                    content=ft.Row(
                        controls=[
                            ft.Icon(ft.Icons.REPORT_PROBLEM, color=ft.Colors.YELLOW),
                ...
                ft.dropdown.Option(
                    text="Histórico (Última Log)",
                    content=ft.Row(
                        controls=[
                            ft.Icon(ft.Icons.HISTORY, color=ft.Colors.CYAN),
                            ft.Text("Histórico (Última Log)", color=ft.Colors.WHITE, size=12)
                        ],
                        alignment=ft.MainAxisAlignment.START
                    )
                ),
                ft.dropdown.Option(
                    ...
                    content=ft.Row(
                        controls=[
                            ft.Icon(ft.Icons.MANAGE_HISTORY, color=ft.Colors.CYAN_ACCENT),
                            ft.Text("Histórico (Completo)", color=ft.Colors.WHITE, size=12)
                        ],
                        alignment=ft.MainAxisAlignment.START
                    )
                ),
                ft.dropdown.Option(
                    text="Cadastrar Ativos",
                    content=ft.Row(
                        controls=[
                            ft.Icon(ft.Icons.ADD_BOX, color=ft.Colors.GREEN_ACCENT),
                            ft.Text("Cadastrar Ativos", color=ft.Colors.WHITE, size=12)
                        ],
                        alignment=ft.MainAxisAlignment.START
                    )
                )
